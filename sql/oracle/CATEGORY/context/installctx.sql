...
--DESCRIBE: install Oracle Intermedia Text (8.1.7 or above)

rem -----------------------------------------------------------------------
rem Filename:   ctxinst.sql
rem Purpose:    Install Oracle Intermedia Text on a database
rem Notes:      Tested on 8.1.7. Will not work on versions below 8.1.7.
rem Author:     Frank Naude, Oracle FAQ
rem -----------------------------------------------------------------------

prompt
prompt Install CTX are you sure
prompt
prompt Press [enter] to continue to <ctrl-C> to abort
pause
