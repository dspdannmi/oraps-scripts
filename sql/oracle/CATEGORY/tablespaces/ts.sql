...
--DESCRIBE: show detailed tablespace usage and free information
...
COLUMN total_tablespace_space      format 9,999,999  heading 'Total|Current|TBS|Space'
COLUMN total_used_space            format 9,999,999  heading 'Total|Current|Used|Space'
COLUMN total_tablespace_free_space format 9,999,999  heading 'Total|Current|Free|Space'
...
COLUMN max_size_of_tablespace      format 9,999,999  heading 'TBS|Max|Extended|Size'
...
SELECT a.tablespace_name,
       ...
       ((files.total_tbs_bytes - fragments.total_tbs_free_bytes) /1024/1024) total_used_space,
