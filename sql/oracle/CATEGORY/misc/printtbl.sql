...
--DESCRIBE: display contents of table one field per line

rem
rem usage printtbl 'select user from dual'
rem
rem From:  asktom.oracle.com
rem

rem Nothing displayed unless serveroutput on is set
set serveroutput on
