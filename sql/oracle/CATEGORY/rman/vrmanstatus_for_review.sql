...
REM acknowledge: https://support.dbagenesis.com/oracle-database/how-to-check-database-backups

--DESCRIBE: show output from v$rman_status

REM check backup status not archivelog
...
REM check backup status for archivelogs
